...
<div class="container page content">
	...
	<section class="section section--mb-40">
		...
		<p><b>Завтраки:</b> Для гостей отеля предоставляется скидка в размере 25% на всё меню с 10:00 до 13:00, в
			...
			ключей.</p>
		<p><b>Рум-сервис:</b> Ресторан Апельсин "Пряности и Страсти" предоставляет услугу рум-сервиса, стоимость
			данной
			услуги составляет 10% от счёта.</p>
		<p><b>Номер для заказа:</b> <a href="tel:79789218792" class="link link--bold link--red">+7(978)
				921-87-92</a>
		</p>
			...
			<div class="swiper-wrapper foobox">
				<div class="swiper-slide">
					<a href="/wp-content/themes/boutique-ps/assets/images/gt-cafe/XXXL.webp" class="foobox">
						<img src="/wp-content/themes/boutique-ps/assets/images/gt-cafe/XXXL.webp"
						     alt="Ресторан GT Cafe"
